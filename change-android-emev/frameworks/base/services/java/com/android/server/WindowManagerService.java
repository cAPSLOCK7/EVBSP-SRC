...
public class WindowManagerService extends IWindowManager.Stub
    ...
    private static final String SYSTEM_SHOWCURSOR = "ro.showcursor";
    ...
    private WindowManagerService(Context context, PowerManagerService pm,
        ...
        mShowMouse = "1".equals(SystemProperties.get(SYSTEM_SHOWCURSOR, "1"));
        mInputThread.start();
    ...
    private final void performLayoutAndPlaceSurfacesLockedInner(
        ...
        if (mShowMouse && mMouseSurface == null) {
            int mMx, mMy, mMw, mMh;
            Canvas mCanvas;
            Path mPath = new Path();
