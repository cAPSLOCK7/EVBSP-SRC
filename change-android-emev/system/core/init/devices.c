...
static struct perms_ devperms[] = {
    ...
    { "/dev/InterDSP/",     0664,   AID_ROOT,       AID_GRAPHICS,   1 },
    { "/dev/ave",           0664,   AID_ROOT,       AID_GRAPHICS,   0 },
    { "/dev/v4l",           0666,   AID_ROOT,       AID_GRAPHICS,   1 },
    { "/dev/siz",           0666,   AID_ROOT,       AID_GRAPHICS,   0 },
    { "/dev/rot0",          0666,   AID_ROOT,       AID_GRAPHICS,   0 },
