...
#define SMU_CPU_RSTCTRL1		(SMU_S0_BASE + 0x0004)
...
#define SMU_A3D_RSTCTRL			(SMU_S0_BASE + 0x006C)
...
#define SMU_USIBS4_RSTCTRL		(SMU_S0_BASE + 0x00A4)
#define SMU_USIBS5_RSTCTRL		(SMU_S0_BASE + 0x00A8)
...
#define SMU_SDIO2_RSTCTRL		(SMU_S0_BASE + 0x00C4)
...
#define SMU_HSI_RSTCTRL			(SMU_S0_BASE + 0x00D8)
...
#define SMU_CRP_RSTCTRL			(SMU_S0_BASE + 0x0128)
...
#define SMU_PLL4CTRL0			(SMU_S0_BASE + 0x0218)
#define SMU_PLL4CTRL1			(SMU_S0_BASE + 0x021C)
...
#define SMU_LSBOOT_MASK			(SMU_S0_BASE + 0x0310)
...
#define SMU_A3DGCLKCTRL			(SMU_S0_BASE + 0x0468)
...
#define SMU_HSIGCLKCTRL			(SMU_S0_BASE + 0x0488)
...
#define SMU_USIBS4GCLKCTRL		(SMU_S0_BASE + 0x04B0)
#define SMU_USIBS5GCLKCTRL		(SMU_S0_BASE + 0x04B4)
...
#define SMU_SDIO2GCLKCTRL		(SMU_S0_BASE + 0x04D0)
...
#define SMU_CRPGCLKCTRL			(SMU_S0_BASE + 0x052C)
...
#define SMU_SDIO2SCLKDIV		(SMU_S0_BASE + 0x0650)
#define SMU_USIB0SCLKDIV		(SMU_S0_BASE + 0x0654)
#define SMU_USIB1SCLKDIV		(SMU_S0_BASE + 0x0658)
...
#define SMU_HSISCLKDIV			(SMU_S0_BASE + 0x0668)
#define SMU_PWMPWCLKDIV			(SMU_S0_BASE + 0x066C)
#define SMU_CAMSCLKDIV			(SMU_S0_BASE + 0x0670)

#define SMU_IRRXPLSCLKDIV		(SMU_S0_BASE + 0x0678)
#define SMU_A3DCORECLKDIV		(SMU_S0_BASE + 0x067C)
...
#define SMU_ADVFSCLKDIV			(SMU_S0_BASE + 0x0694)
...
#define SMU_AUTO_DMDIVCNG_MODE		(SMU_S0_BASE + 0x0730)
#define SMU_AUTO_DMDIVCNG_PARAM		(SMU_S0_BASE + 0x0734)
...
#define SMU_P2_SWON			(SMU_S0_BASE + 0x0850)
...
#define CHG_GIOMASK000			(CHG_BASE + 0x0220)
#define CHG_GIOMASK032			(CHG_BASE + 0x0224)
#define CHG_GIOMASK064			(CHG_BASE + 0x0228)
#define CHG_GIOMASK096			(CHG_BASE + 0x022C)
#define CHG_GIOMASK128			(CHG_BASE + 0x0230)

#define CHG_PINSEL_LCD			(CHG_BASE + 0x0280)
#define CHG_PINSEL_LCD3			(CHG_BASE + 0x0284)
#define CHG_PINSEL_UART			(CHG_BASE + 0x0288)
#define CHG_PINSEL_IIC			(CHG_BASE + 0x028C)
#define CHG_PINSEL_SD			(CHG_BASE + 0x0290)
#define CHG_PINSEL_AB			(CHG_BASE + 0x0294)
#define CHG_PINSEL_USI			(CHG_BASE + 0x0298)
#define CHG_PINSEL_NTSC			(CHG_BASE + 0x029C)
#define CHG_PINSEL_CAM			(CHG_BASE + 0x02A0)
#define CHG_PINSEL_HSI			(CHG_BASE + 0x02A8)
...
#define CHG_CFI_WP_SET			(CHG_BASE + 0x0524)

#define CHG_MON_OUTREG			(CHG_BASE + 0x0730)

#define CHG_LOOPBACK			(CHG_BASE + 0x07D0)
#define CHG_BDS				(CHG_BASE + 0x07D4)
