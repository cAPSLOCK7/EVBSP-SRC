...
#define SDM_USER			(SDC_BASE + 0x0200)
#define SDM_USER2			(SDC_BASE + 0x0204)
...
/* HFB clock(=88.8MHz) */
#define SDM_CLK_NORMAL_SPEED		SDM_CLK_CTRL_DIV4			/* 22.2Mhz */
#define SDM_CLK_HIGH_SPEED		(SDM_CLK_CTRL_DIV2 | SDM_CLK_CTRL_HIGH)	/* 44.4MHz */
