...
#endif
#if defined(CONFIG_CMD_NET) && defined(CONFIG_DRIVER_DM9000)
		dm9000_check_mac_addr(bd->bi_enetaddr);
...
U_BOOT_CMD(
	...
	"clear environment variables in persistent storage",
	NULL
);
#endif	/* CONFIG_ENV_IS_IN_MMC && !CONFIG_ENV_IS_NOWHERE */
